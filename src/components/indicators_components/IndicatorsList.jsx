...
const allColumns2 = {
    ...
    status: {
        ...
        filter: true,
        filterField: "status",
        filterElement: (option) => (<FilterIndicators options={option} data={statusValue} itemTemplate={ItemTemplate} />),
    ...
    selected_indicator: {
        ...
        filter: true,
        filterElement: (option) => (<FilterIndicators options={option} data={selected_indicator} itemTemplate={ItemTemplate}/>),
        showFilterMatchModes: false,
        style: { minWidth: '12rem' },
    ...
    piloting: {
        ...
        filterElement: (option) => (<FilterIndicators options={option} data={piloting} itemTemplate={ItemTemplate}/>),
        showFilterMatchModes: false,
        style: { minWidth: '12rem' },
    ...
    pilot_outcome: {
        ...
        filterElement: (option) => (<FilterIndicators options={option} data={pilot_outcome} itemTemplate={ItemTemplate}/>),
        showFilterMatchModes: false,
        style: { minWidth: '12rem' },
